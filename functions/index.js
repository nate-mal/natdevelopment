  ...
  if (total) {
    if (category) {
      mailOptions = {
        ...mailOptions,
        to: "malitan.contact@gmail.com",
        subject: `New estimate received from ${name}`,
        html: `<p style="fonT-size:16px;">Name: ${name}</p>
    <p style="fonT-size:16px;">Email: <a href="mailto:${email}"> ${email}</a></p>
    <p style="fonT-size:16px;">Phone: <a href="tel:${phone}"> ${phone}</a></p>
                            ...
                            <tr>
                              <td align="center">
                                <a href="http://www.google.com/" target="_blank">
                                  <img
                                    align="center"
                                    src="https://i.postimg.cc/VLHKxjFx/art-dev.jpg"
                                    alt="Arc Development"
                                    width="600"
                                    height=""
                                    style="
